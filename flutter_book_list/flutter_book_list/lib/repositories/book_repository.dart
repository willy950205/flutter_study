...
class BookRepository {
  final List<Book> _dummyBooks = [
    Book(
        ...
        description:
            '머신러닝과 강화학습의 기본 개념부터 심층 강화학습의 알고리즘과 발전방향까지! 본 서는 강화학습의 기본 요소와 작동 원리에 대해 상세히 다루는데, 딥러닝 프레임 워크를 사용하는 것이 아닌, R base code로 강화학습을 구현하여강화학습 작동원리를 이해한다.',
    ...
    Book(
        ...
        description:
            'Vue.js 프로젝트 투입 일주일 전』은 실무에서 프로젝트를 개발하는 진행 순서에 맞춰서 구성했기 때문에 초보자도 충분히 따라할 수 있으며，개발 기초 지식이 있는 독자라면 조금 더 빠르게 V니e.js를 배울 수 있다. 개발 환경 설정부터 웹 맵구현까지 책을 따라 하면서 자연스럽게 실무에 필요한 내용을 배워 보자',
